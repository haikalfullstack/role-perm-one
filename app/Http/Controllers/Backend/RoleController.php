...
class RoleController extends Controller
{
    ...
    public function AddRolesPermissions(){
        $roles = Role::all();
        $permissions = Permission::all();
        $permissions_groups = User::getPermissionsGroups();
        return view('backend.pages.permissions.add_roles_permissions', compact('roles', 'permissions', 'permissions_groups'));
    }

    public function RolesPermissionsStore(Request $request){
        $data = array();
        ...
        $notification = array(
            'message' => 'Roles Permission Updated Sucessfully',
            'alert-type' => 'success'
        );
    ...
    public function AllRolesPermissions(){
        $roles = Role::all();
        return view('backend.pages.permissions.all_roles_permissions', compact('roles'));
    }
    ...
    public function AdminEditRoles($id){
        ...
        $permissions = Permission::all();
        $permissions_groups = User::getPermissionsGroups();
        return view('backend.pages.permissions.edit_roles_permissions', compact('roles', 'permissions', 'permissions_groups'));
    }
}
